...
process.env.TONE_USERNAME=process.env.TONE_USERNAME||ibmSetupKey.toneIbm.toneUsername;
process.env.TONE_PASSWORD=process.env.TONE_PASSWORD||ibmSetupKey.toneIbm.tonePassword;
process.env.TONE_VERSION_DATE=process.env.TONE_VERSION_DATE||ibmSetupKey.toneIbm.toneVersion_date;
console.log("Set up for Tone Analyzer Service wrapper for version dated : ",process.env.TONE_VERSION_DATE); 

// Set up Tone  service wrapper.
  var tone_analyzer = new ToneAnalyzerV3({
    username: process.env.TONE_USERNAME,
    password:process.env.TONE_PASSWORD,
    version_date: process.env.TONE_VERSION_DATE
  });
...
// export
module.exports = {config,conversation,tone_analyzer,connect,get,collectionJobDomain,collectionApplicant};
