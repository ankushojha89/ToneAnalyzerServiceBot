var bot = {};
bot.avatar = "http://www.chatterbotcollection.com/images/telegram-bot_1436220825.png";

var user = {};
user.avatar = "https://artemisbot.com/static/logo.png";
...
function botTalk(message){
    ...
    $.ajax({
        ...
        success: function(res) {
            ...
            if(res.response.output.toneAnalyze==true){      
                document.getElementById("input_message").value =message;
                document.getElementById("output_message").value =JSON.stringify(res.response.output.tone,undefined,2);
